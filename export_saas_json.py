#!/usr/bin/env python3
"""
Export SaaS Brain BM25 index to JSON for the App Builder Node.js action.
Output: saas_brain_index.json
"""
...
INDEX_FILE = Path(__file__).parent / "saas_brain.pkl"
OUTPUT_FILE = Path(__file__).parent / "saas_brain_index.json"
